...
OBJS= user.o db_parser.o product.o product_parser.o util.o amazon.o book.o clothing.o movie.o mydatastore.o
...
db_parser.o: db_parser.cpp db_parser.h product_parser.h datastore.h 
